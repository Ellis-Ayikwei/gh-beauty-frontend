  ...
  return (
    <>
      <div className="relative flex h-screen bg-white md:grid place-items-center">
        <div className="flex">
          <img
            className="rounded-tl-[43px] rounded-bl-[47px]"
            src={Images.signUpImg}
            alt=""
          />
          <div className="flex items-center">
            <div className="md:m-auto h-full mt-60 border-r-[1px] mx-5 px-[55px] py-[42px] md:w-[420px] rounded-r-[42px] text-white shadow-[0px_0px_2px_0.1px_#555252]">
              <h3 className="font-bold text-black text-[24px]">
                Sign up to GH Beauty
              </h3>
              <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="w-full mt-5">
                  ...
                  <div className="relative w-full flex rounded-[28px] border-white border-[0.5px]">
                    <input
